...
export const metadata: Metadata = {
  title: 'Contacto',
  description:
    'Contáctanos en Hostal Nómada. C/ Benito Monción 29, esq. Máximo Gómez 34, Centro Histórico, Santiago de los Caballeros, RD. WhatsApp disponible.',
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          <div className="rounded-2xl overflow-hidden h-96 shadow-sm">
            <iframe
              ...
              title="Mapa — Hostal Nómada, Centro Histórico Santiago de los Caballeros"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
