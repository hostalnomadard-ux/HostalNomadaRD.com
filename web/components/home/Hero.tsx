...
export function Hero() {
  return (
    <section className="relative min-h-[92vh] flex flex-col justify-end overflow-hidden">
      ...
      <div className="absolute inset-0 bg-carbon hero-bg">
        <Image
      ...
      <div className="relative max-w-6xl mx-auto px-4 pb-16 pt-32 w-full flex justify-start">
        <div className="max-w-xl w-full">
          <p className="hero-tag text-verde-fresco text-xs font-semibold tracking-[0.2em] uppercase mb-4">
            Benito Monción esq. Máximo Gómez · Santiago, RD
          </p>

          <h1 className="hero-h1 text-5xl md:text-6xl font-bold text-white leading-[1.05] mb-6">
            Hostal boutique en el centro histórico de Santiago, RD.
          </h1>

          <p className="hero-p text-gray-300 text-lg md:text-xl mb-10 leading-relaxed">
          ...
          <div className="hero-buttons flex flex-col sm:flex-row gap-4 mb-10">
          ...
          {/* Rating strip */}
          <div className="hero-rating flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-gray-400">
