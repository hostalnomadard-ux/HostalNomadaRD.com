...
const values = [
  {
    icon: Home,
    title: 'Historia viva',
    text: 'Nuestro edificio tiene más de 75 años. Fue construido como residencia y consultorio médico, estuvo abandonado por más de 20 años, y lo restauramos conservando su alma.',
  },
  {
    icon: Heart,
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-verde-fresco rounded-2xl p-8 md:p-12 text-white mb-12">
            ...
            <p className="text-white/90 leading-relaxed text-lg">
              Con más de 75 años de historia, este edificio fue construido como residencia y consultorio del Dr. José Jiménez Almonte y ha sido restaurado tras permanecer abandonado por más de 20 años. Su arquitectura conserva
          ...
          <div className="text-center mt-12 text-sm text-gray-500">
            ...
            <div className="flex justify-center gap-6 mt-6">
              <Link href="/habitaciones" className="text-verde-fresco font-semibold hover:text-verde-fresco-dark transition-colors">
                Ver habitaciones →
              </Link>
              <Link href="/reservar" className="text-royal-blue font-semibold hover:text-royal-blue-dark transition-colors">
                Reservar ahora →
              </Link>
            </div>
          </div>
